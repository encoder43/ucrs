        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            if opt.resume.startswith(WANDB_ARTIFACT_PREFIX):
                ...
                try:
                    ...
                    print(f"{prefix}Failed to initialize wandb (resume): {e}. Continuing without wandb logging.")
                    self.wandb_run = None
                    self.wandb = None
        elif self.wandb:
            try:
                ...
                prefix = colorstr('wandb: ')
                print(f"{prefix}Failed to initialize wandb: {e}. Continuing without wandb logging.")
                self.wandb_run = None
                self.wandb = None
        if self.wandb_run:
            ...
            if not wandb:
                ...
                print(f"{prefix}Wandb not configured. Continuing without wandb logging. To enable, run 'wandb login' or set WANDB_API_KEY environment variable.")
